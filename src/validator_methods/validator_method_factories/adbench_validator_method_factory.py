...
class PCAAnomalyValidatorMethod(DataValidatorMethod):
    ...
    @override
    def name(self) -> str:
        method_name = self.model.__module__.split(".")[-1]
        return f"{method_name}_anomaly_validator_method"
    ...
    def validate(
        ...
        @return:
        """
        model_instance = PCAAnomalyValidatorMethod.model()
        model_instance.fit(data_matrix)
        anomaly_scores = model_instance.decision_function(data_matrix)
...
class CBLOFAnomalyValidatorMethod(DataValidatorMethod):
    """
    A method for determining multidimensional anomalies. Operates on continuous datasets.
    """
    model = cblof.CBLOF 
    ...
    def validate(
        ...
        @return:
        """
        model_instance = CBLOFAnomalyValidatorMethod.model()
        model_instance.fit(data_matrix)
        anomaly_scores = model_instance.decision_function(data_matrix)
...
class IForestAnomalyValidatorMethod(DataValidatorMethod):
    """
    A method for determining multidimensional anomalies. Operates on continuous datasets.
    """
    model = iforest.IForest
    ...
    def validate(
        ...
        @return:
        """
        model_instance = IForestAnomalyValidatorMethod.model()
        model_instance.fit(data_matrix)
        anomaly_scores = model_instance.decision_function(data_matrix)
